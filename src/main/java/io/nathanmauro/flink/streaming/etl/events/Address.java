...
public class Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8910146585706227693L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Address\",\"namespace\":\"io.nathanmauro.flink.streaming.etl.events\",\"fields\":[{\"name\":\"num\",\"type\":\"int\"},{\"name\":\"street\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"zip\",\"type\":\"string\"}]}");
   ...
   */
  public static io.nathanmauro.flink.streaming.etl.events.Address.Builder newBuilder() {
    return new io.nathanmauro.flink.streaming.etl.events.Address.Builder();
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static io.nathanmauro.flink.streaming.etl.events.Address.Builder newBuilder(io.nathanmauro.flink.streaming.etl.events.Address.Builder other) {
    return new io.nathanmauro.flink.streaming.etl.events.Address.Builder(other);
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static io.nathanmauro.flink.streaming.etl.events.Address.Builder newBuilder(io.nathanmauro.flink.streaming.etl.events.Address other) {
    return new io.nathanmauro.flink.streaming.etl.events.Address.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Address>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.nathanmauro.flink.streaming.etl.events.Address.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.nathanmauro.flink.streaming.etl.events.Address other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.num)) {
        this.num = data().deepCopy(fields()[0].schema(), other.num);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder setNum(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder clearNum() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder setStreet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder setZip(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.nathanmauro.flink.streaming.etl.events.Address.Builder clearZip() {
      zip = null;
